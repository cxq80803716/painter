...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "painter.py"
        # 游戏名
        self.project_name = "painter"
        # 游戏site
        ...
        # 游戏作者
        self.author_name = "cxq"
        # 联系电邮
        self.author_email = "80803716@qq.com"
        # 游戏版权
        self.copyright = "cxq"
        # 游戏描述
        self.project_description = "painter"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = os.path.join("./img","icon.ico")
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ["img"]
        # 额外需要的python库名
        ...
        self.zipfile_name = "painter"
        # 生成文件夹
        self.dist_dir ='painter'
